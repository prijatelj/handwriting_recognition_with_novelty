...
if [ "$SGE_TASK_ID" -eq "1" ]; then
    ...
    RIMES_PATH="$BASE_RIMES/iam_split_0_labels.json"
    ...
    RIMES_PATH="$BASE_RIMES/iam_split_1_labels.json"
    ...
    RIMES_PATH="$BASE_RIMES/iam_split_2_labels.json"
    ...
    RIMES_PATH="$BASE_RIMES/iam_split_3_labels.json"
    ...
    RIMES_PATH="$BASE_RIMES/iam_split_4_labels.json"
